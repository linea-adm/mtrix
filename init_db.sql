...
CREATE TABLE IF NOT EXISTS clientes (
    ...
    CUSTOMER_NEIGHBORHOOD VARCHAR(200),
    CUSTOMER_CITY VARCHAR(200),
    CUSTOMER_UF VARCHAR(2),
    CUSTOMER_ZIPCODE VARCHAR(8),
    CUSTOMER_SEGMENTATION VARCHAR(60),
    CUSTOMER_FLAG VARCHAR(1),
    PRIMARY KEY (DISTRIBUTOR_CODE, CUSTOMER_ID)  -- Chave primária composta
);
